...
When a commit to the `master` branch occurs (for example, when a pull request is merged), CI builds the manuscript and writes the results to the [`gh-pages`](https://github.com/dib-lab/2020-paper-sourmash-gather/tree/gh-pages) and [`output`](https://github.com/dib-lab/2020-paper-sourmash-gather/tree/output) branches.
...
Please attribute by linking to https://github.com/dib-lab/2020-paper-sourmash-gather.
...
Please open [an issue](https://github.com/dib-lab/2020-paper-sourmash-gather/issues) for any question related to licensing.
