...
A rank ordering of the best 30 genomes matching to the synthetic
metagenome from Shakya et al., the minimal set cover
from 700,000 genomes.
...
GenBank, 73 were selected by the midn-set cov algorithm, and they
